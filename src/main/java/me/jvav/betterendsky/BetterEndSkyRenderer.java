...
public class BetterEndSkyRenderer implements DimensionRenderingRegistry.SkyRenderer {
    private static final ResourceLocation NEBULA_1 = new ResourceLocation(BetterEndSky.MOD_ID, "textures/sky/nebula_2.png");
    private static final ResourceLocation NEBULA_2 = new ResourceLocation(BetterEndSky.MOD_ID, "textures/sky/nebula_3.png");
    private static final ResourceLocation HORIZON = new ResourceLocation(BetterEndSky.MOD_ID, "textures/sky/nebula_1.png");
    private static final ResourceLocation STARS = new ResourceLocation(BetterEndSky.MOD_ID, "textures/sky/stars.png");
    private static final ResourceLocation FOG = new ResourceLocation(BetterEndSky.MOD_ID, "textures/sky/fog.png");
